    ...
    <main class="container-fluid">
        <div class="row fs-top">
            ...
            <div class="col-sm-9">
                <div class="card">
                    {{-- 菜单 --}}
                    @if (fs_db_config('forumq_notifications', []))
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs">
                                ...
                                @if (in_array('systems', fs_db_config('forumq_notifications', [])))
                                    <li class="nav-item">
                                ...
                                @if (in_array('recommends', fs_db_config('forumq_notifications', [])))
                                    <li class="nav-item">
                                ...
                                {{-- like notifications --}}
                                @if (in_array('likes', fs_db_config('forumq_notifications', [])))
                                    <li class="nav-item">
                                ...
                                @if (in_array('dislikes', fs_db_config('forumq_notifications', [])))
                                    <li class="nav-item">
                                ...
                                @if (in_array('follows', fs_db_config('forumq_notifications', [])))
                                    <li class="nav-item">
                                ...
                                {{-- block notifications --}}
                                @if (in_array('blocks', fs_db_config('forumq_notifications', [])))
                                    <li class="nav-item">
                                ...
                                @if (in_array('mentions', fs_db_config('forumq_notifications', [])))
                                    <li class="nav-item">
                                ...
                                @if (in_array('comments', fs_db_config('forumq_notifications', [])))
                                    <li class="nav-item">
                                ...
                                {{-- quote notifications --}}
                                @if (in_array('quotes', fs_db_config('forumq_notifications', [])))
                                    <li class="nav-item">
