    ...
    <section class="content-main order-2 mx-3 position-relative">
        ...
        <div class="content-title d-flex flex-row bd-highlight">
            ...
            @if ($post['stickyState'] == 2)
                <img src="/assets/ForumQ/images/icon-sticky.png" loading="lazy" alt="小组页置顶" class="ms-2">
            @elseif ($post['stickyState'] == 3)
                <img src="/assets/ForumQ/images/icon-sticky.png" loading="lazy" alt="全局置顶" class="ms-2">
            @endif

            {{-- 精华 --}}
            @if ($post['digestState'] == 2)
                <img src="/assets/ForumQ/images/icon-digest.png" loading="lazy" alt="一级精华" class="ms-2">
            @elseif ($post['digestState'] == 3)
                <img src="/assets/ForumQ/images/icon-digest.png" loading="lazy" alt="二级精华" class="ms-2">
            @endif
        </div>
        ...
        <div class="d-flex border-top pt-2">
            ...
            <div class="interaction-box fresns-trigger-reply">
                <a class="btn btn-inter" href="javascript:;" role="button">
                    ...
                    @else
                        <img src="/assets/ForumQ/images/icon-comment.png" loading="lazy">
                    @endif
                    <span class="cm-count">
                        {{ $post['commentCount'] }}
                    </span>
            ...
            <div class="interaction-box dropup">
                <button class="btn btn-inter" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    @else
                        <img src="/assets/ForumQ/images/icon-share.png" loading="lazy">
                    @endif
                </button>
            ...
            <div class="ms-auto dropup text-end">
                <button class="btn btn-inter" type="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                    ...
                    @else
                        <img src="/assets/ForumQ/images/icon-more.png" loading="lazy">
                    @endif
                </button>
