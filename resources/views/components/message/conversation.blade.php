            ...
            <h5 class="mb-1">
                @if ($conversation['user']['status'])
                    ...
                    @if ($conversation['user']['verifiedStatus'])
                        ...
                        @else
                            <img src="/assets/ForumQ/images/icon-verified.png" loading="lazy" class="conversation-user-verified" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $conversation['user']['verifiedDesc'] }}">
                        @endif
                    @endif
