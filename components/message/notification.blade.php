                    ...
                    <a href="{{ fs_route(route('fresns.profile.index', ['uidOrUsername' => $notification['actionUser']['fsid']])) }}" class="user-link d-flex">
                        ...
                        @if ($notification['actionUser']['verifiedStatus'])
                            <div class="user-verified">
                                ...
                                @else
                                    <img src="/assets/themes/ForumQ/images/icon-verified.png" loading="lazy" alt="Verified" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $notification['actionUser']['verifiedDesc'] ?? '' }}">
                                @endif
                            </div>
                        @endif
