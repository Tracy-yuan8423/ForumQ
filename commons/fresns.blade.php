...
<head>
    ...
    <link rel="stylesheet" href="/assets/themes/ForumQ/css/atwho.min.css?v={{ $themeVersion }}">
    <link rel="stylesheet" href="/assets/themes/ForumQ/css/prism.min.css?v={{ $themeVersion }}">
    <link rel="stylesheet" href="/assets/themes/ForumQ/css/fresns.css?v={{ $themeVersion }}">
...
<body>
    ...
    @if (fs_user()->guest())
        <div class="modal fade" id="postTipModal" tabindex="-1" aria-labelledby="postTipModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="postTipModalLabel">{{ fs_db_config('publish_post_name') }}</h1>
    ...
    @mobile
        <div class="modal fade" id="groupsModal" tabindex="-1" aria-labelledby="groupsModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="groupsModalLabel">{{ fs_db_config('group_name') }}</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
    ...
    <script src="/assets/themes/ForumQ/js/jquery.caret.min.js?v={{ $themeVersion }}"></script>
    <script src="/assets/themes/ForumQ/js/atwho.min.js?v={{ $themeVersion }}"></script>
    <script src="/assets/themes/ForumQ/js/prism.min.js?v={{ $themeVersion }}"></script>
    <script src="/assets/themes/ForumQ/js/fresns.js?v={{ $themeVersion }}"></script>
    @stack('script')
</body>
